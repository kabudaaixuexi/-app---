...
function replaceVNode(prev, next, container) {
    ...
    (0, mount_1.mount)(next, container);
}
        ...
        case childrenType.EMPTY:
            switch (nextChildrenFlag) {
                ...
                case childrenType.SINGLE:
                    (0, mount_1.mount)(nextChildren, container);
                    break;
                case childrenType.MULTIPLE:
                    for (let i = 0; i < nextChildren.length; i++) {
                        (0, mount_1.mount)(nextChildren[i], container);
                    }
                    break;
            }
            break;
                ...
                case childrenType.MULTIPLE:
                    ...
                    for (let i = 0; i < nextChildren.length; i++) {
                        ...
                        if (!isFind) {
                            ...
                            (0, mount_1.mount)(nextVNode, container, flagNode);
                        }
                    }
