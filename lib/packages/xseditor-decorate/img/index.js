...
const _message_1 = __importDefault(require("../_message"));
const onResize_1 = __importDefault(require("./onResize"));
onResize_1.default(null);
function default_1(region, Config) {
    return {
        xs_tag: "xs-nav",
        xs_type: 1,
        xs_data: {
        ...
        children: [
            {
              ...
              `);
                            Config.onChange && Config.onChange(region, achieveVd_1.achieveVd(region));
                        });
                    },
                },
                children: [],
