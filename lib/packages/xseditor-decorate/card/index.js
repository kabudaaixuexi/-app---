...
exports.default = {
    ...
    children: [
        ...
        },
        {
            ...
            children: config_1.cards.map((ce) => ({
                xs_type: 2,
                xs_value: ce
            }))
        }
