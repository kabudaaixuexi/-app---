    ...
    xs_data: {
        ...
        onClick: (e) => {
            ...
            if (hasClass(Ele, 'xs-hiliteColor-show')) {
                ...
                newClass = [
                    ...newClass
                ].filter((ca) => ca !== 'xs-hiliteColor-hide');
                Ele.className = newClass.join(' ');
            }
        }
    },
        ...
        },
        {
            ...
            children: config_1.colors.map((ce) => ({
                ...
                xs_data: {
                    ...
                    onClick: () => {
                        (0, changeStyle_1.default)({ command: 'hiliteColor', value: ce });
                    }
                },
                children: []
            }))
